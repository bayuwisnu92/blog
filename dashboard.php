                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php if (cek_status($putri) == 1) : ?>
                                <a href="crud/edit.php?id=<?php echo $row['id']; ?>" class="btn btn-warning btn-sm me-2"><i class="bi bi-pencil"></i> Edit</a>
                                <a href="crud/hapus.php?id=<?php echo $row['id']; ?>" class="btn btn-danger btn-sm"><i class="bi bi-trash"></i> Delete</a>
                                <?php endif; ?>
                            </div>
                        </td>
                    </tr>
